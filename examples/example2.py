...
e_mesh, dos = get_density_of_states('data/cacuo2-cu3d-dos.lda.txt')
...
ax1.text(0.1, 0.5, r'CaCuO$_{2}$', transform=ax1.transAxes)
...
plt.savefig('data/example2-output.png', bbox_inches='tight')
